...
<dl class="dl-horizontal">
  <dt style="display:block;width:253px;height:30px;border-top:1px dashed #eee;margin-top:10px;line-height:30px;"><p style="float:left;margin-left:10px;"><font class="color:#ccc;">用户名</font>:<font class="font-weight:bold;">{{ $user->uname }}</p></label></dt><dd style="text-align:center;"></dd>
  <dt style="width:253px;height:30px;line-height:30px;border-top:1px dashed #eee;">
    <p style="float:left;margin-left:10px;">注册时间:{{ $user->created_at }}</p>
  </dt>
  </dl>
<div class="clearfix"></div>
           <a class="btn btn-primary btn-block" href="/myinfo/create" id="user-edit-button">
           <i class="fa fa-edit"></i> 头像设置
           </a>
  </div> 
  </div>  
  ...
  <div class="col-md-9 left-col">
   ...
   <li class="active">
    <a href="/myinfo/edit/{ $user->id }" >个人信息</a>
  </li>
  <li class="">
  ...
  <li class="">
    <a href="https://www.010hub.com/user/25/favorites" >收藏</a>
      ...
      <form action="/myinfo/{{ $user->id }}"  method="POST" >
            {{ csrf_field() }}
            {{ method_field('PUT') }}
          <label>用户名：</label>
          ...
          <div class="form-group status-post-submit">
            <input class="btn btn-primary" id="user-edit-submit" type="submit" value="补充修改">
          </div>
        </form>
    </div>
  </div>
