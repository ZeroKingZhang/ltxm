...
<div class="panel">
	...
	<form action="/user" method="POST">
		...
		<div class="panel-body" style="width:500px;height:600px;margin:0px auto;">
			<label>用户名：</label>
			<input type="text"  class="form-control" name="admin_user_name" value="{{ old('aname') }}" placeholder="请输入用户名" style="width:400px">
			<br>
			<label>密  &nbsp; &nbsp; 码：</label>
			...
			<br>
			<label>邮  &nbsp; &nbsp; 箱：</label>
			<input type="text"  class="form-control" name="admin_user_email" value="{{ old('email') }}" placeholder="请输入邮箱" style="width:400px">
			<br>
			<label>手机号：</label>
			<input type="text"  class="form-control" name="admin_user_phone" value="{{ old('phone') }}" placeholder="请填写手机号" style="width:400px">
			<br>
			<label>权限：</label>
